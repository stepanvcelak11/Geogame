...
export const NEAREST_BASE_KM: Record<LocationId, number> = { kancelar: 12, stavba: 31, louka: 38, les: 44, kraj: 20 };

/** Síla mobilního signálu pro NTRIP (0…1). Na louce za kopcem slabší, korekce občas vypadnou. */
export const DATA_SIGNAL: Record<LocationId, number> = { kancelar: 1, stavba: 0.9, louka: 0.55, les: 0.5, kraj: 0.8 };
